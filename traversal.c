 ...
 * This function performs a breadth-first search (BFS) traversal starting from the given vertex index
 * and creates the text file containing the breadth-first search (BFS) traversal sequence
